...
export default defineComponent({
	...
	setup() {
		...
		return () => {
			const activeBall = activeIndex.value === null ? null : (balls.value[activeIndex.value] ?? null);
			...
			return (
				<div class="home" ref={containerRef}>
						...
						<div class="home-stage">
							{balls.value.map((ball, index) => (
								<div
									...
									class={["module-ball", ball.focused && "is-focused"].filter(Boolean).join(" ")}
									style={{
					...
					{activeBall && (
						<div class={["home-mask", isClosing.value && "is-closing"].filter(Boolean).join(" ")}>
							<div class="home-modal">
								<div
									...
									<div class="home-modal-tip">双击进入模块 · 移出球体关闭</div>
								</div>
							</div>
						</div>
					)}
